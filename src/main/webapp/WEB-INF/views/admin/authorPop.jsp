...
<link rel="stylesheet" href="/css/admin/authorPop.css">
<script
...
<body>
	...
	<div class="content_wrap">
				...
				<div class="table_exist">
	       		...
	       		<c:forEach items="${list}" var="list">
		       		<tr>
		       			...
		       			<td>
		       				<a href='<c:out value="${list.authorId}"/>' class="move" data-name='<c:out value="${list.authorName}"/>'>
		...
		<div class="search_wrap">
			<form action="/admin/authorPop" id="searchForm" method="get">
