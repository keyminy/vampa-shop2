...
<body>
	...
	<script>
		$(document).ready(function(){
			/* 평점은 JS코드를 통해 출력, 팝업창이 렌더링 될 때 동작 */
			let rating = '${replyInfo.rating}';//controller로부터 전달받은 값
			//option객체가 가지고 있는 모든 요소에 순차적으로 접근
			$("option").each(function(idx,obj){
				if(rating === $(obj).val()){
					//변수 rating에 담긴 값과 동일할 때,해당 <option>태그에 "selected"속성 추가되도록
		...
		$(".update_btn").on("click", function(e){
			...
			const rating = $("select").val(); //선택한 option값 가져오기!!
